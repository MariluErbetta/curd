                ...
                <input type="hidden" name="id" value=" <?php echo $row['id']; ?>" >
					...
					<div class="modal-body">					
						<div class="form-group">
							...
							<input name="first_name" type="text" value= " <?php echo $row['first_name'];?>" class="form-control">
						</div>
                        <div class="form-group">
						...
						<div class="form-group">
							...
							<input name="job_title" type="text" value=" <?php echo $row['job_title'];?>" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Salary</label>
						...
						<div class="form-group">
							<label>Notes</label>
							<input name="notes" type="text" value=" <?php echo $row['notes'];?>" class="form-control" required>
						</div>					
					</div>
